...
(function(global, factory) {
    ...
    // Default options for iScroll.js库 used when using scrollOverflow
    var iscrollOptions = {
        scrollbars: true,
        mouseWheel: true,
    ...
    $.fn.fullpage = function(options) {
        ...
        */
        ...
        /**
        * Turns fullPage.js库 to normal scrolling mode when the viewport `width` or `height`
        ...
        */
        ...
        /*
        * Destroys fullpage.js库 plugin events and optinally its html markup and styles
        */
        ...
        /*
        * Removes inline styles added by fullpage.js库
        */
        ...
        */
        function displayWarnings(){
            ...
            if($('html').hasClass(ENABLED)){
                showError('error', 'Fullpage.js库 can only be initialized once and you are doing it multiple times!');
                return;
            }
            ...
            extensions.forEach(function(extension){
                ...
                if(options[extension]){
                    showError('warn', 'fullpage.js库 extensions require jquery.fullpage.extensions.min.js库 file instead of the usual jquery.fullpage.js. Requested: '+ extension);
                }
            });
     ...
     * to the fullpage.js库 option that implements the same functions
     * as this handler.
     *
     * @type {Object}
     */
