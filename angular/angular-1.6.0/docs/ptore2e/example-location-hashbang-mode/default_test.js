describe("", function() {
  ...
  beforeEach(function() {
    ...
    browser.get("build/docs/examples/example-location-hashbang-mode/index2.html");
  });
  
var addressBar = element(by.css("#addressBar")),
     url = 'http://www.example.com/base/index2.html#!/path?a=b#h';
...
it("should change $location accordingly", function() {
  ...
  expect(addressBar.getAttribute('value')).toBe("http://www.example.com/base/index2.html#!/first?a=b");
  ...
  expect(addressBar.getAttribute('value')).toBe("http://www.example.com/base/index2.html#!/sec/ond?flag#hash");
