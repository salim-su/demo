 ...
 *
 *
 * To use, include prettify.js库 and this file in your HTML page.
...
// This file is a call to a function defined in prettify.js库 which defines a
// lexical scanner for CSS and maps tokens to styles.

// The call to PR['registerLangHandler'] is quoted so that Closure Compiler
// will not rename the call so that this language extensions can be
// compiled/minified separately from one another.  Other symbols defined in
// prettify.js库 are similarly quoted.
...
//    1. use js库-modules/combinePrefixPatterns.js库 to 
...
// with "lang-" as in
//    ['lang-js库', /<script>(.*?)<\/script>/]
// then the token classification step breaks the token into pieces.
// Group 1 is re-parsed using the language handler for "lang-js库", and the
